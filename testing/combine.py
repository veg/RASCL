...
arguments.add_argument(
    '-r',
    '--reference_seq',
    help='Reference sequence (single sequence)',
    required=False,
    type=str)
...
input_stamp = run_command(
    ...
    [
        ...
        query_compressed],
    tn93_pairwise_calcs,
    "filtering reference sequuences that are closer than %g to any query cluster" %
    (threshold *
     2.0))
